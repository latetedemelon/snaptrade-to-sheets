...
- **📊 Refresh Accounts** - Creates an Accounts sheet with all connected accounts
- **💰 Refresh Holdings** - Creates a Holdings sheet with your current positions
- **💵 Refresh Balances** - Creates a Balances sheet with cash and buying power
...
### Balances Sheet
Generated by **📊 SnapTrade → 💵 Refresh Balances**
...
**Note:** The **Raw Data** column in Accounts and Transactions sheets contains the complete JSON response from the SnapTrade API, useful for debugging or accessing additional fields. The **Notes** and **Attachment** columns are placeholders for manual data entry.
